...
When comparing different Python versions, Python 3.12 and 3.13 produced the same hash, while Python 3.14 produced a different one. This may be caused by changes in how Python 3.14 serializes this object.
